...
The `home-routes` handler in the `web-app-beta.routes.home` namespace
...
The `home-page` function will in turn call the `web-app-beta.layout/render` function
...
The routes are aggregated and wrapped with middleware in the `web-app-beta.handler` namespace:
...
Request middleware functions are located under the `web-app-beta.middleware` namespace.

This namespace is reserved for any custom middleware for the application. Some default middleware is
already defined here. The middleware is assembled in the `wrap-base` function.

Middleware used for development is placed in the `web-app-beta.dev-middleware` namespace found in
